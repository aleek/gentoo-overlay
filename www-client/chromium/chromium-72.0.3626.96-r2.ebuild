...
SLOT="0"
KEYWORDS="amd64 ~x86"
IUSE="component-build cups gnome-keyring +hangouts jumbo-build kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu +system-libvpx +tcmalloc widevine vaapi"
RESTRICT="
	!system-ffmpeg? ( proprietary-codecs ( branding ) )
...
PATCHES=(
	...
	"${FILESDIR}/enable_chromecast_by_default.patch"
)
...
src_prepare() {
	...
	use vaapi && eapply "${FILESDIR}/enable_vaapi_on_linux_2_73.diff"
